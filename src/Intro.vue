  ...
  <tr>
    ...
    <td>
      <form @change="$emit('updateConfig', config)">
        <label>
          Number of questions: <input type="number" name="question-total" min="1" max="99" v-model="config.questionTotal">
        </label><br>
        <label>
          Time limit:
          <select name="time-limit" v-model.number="config.timeLimit">
